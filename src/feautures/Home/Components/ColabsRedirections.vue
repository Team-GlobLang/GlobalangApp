    ...
    <div class="flex flex-col md:flex-row gap-6 w-full">
        ...
        <div v-if="userRole === 'BASIC' || userRole === 'COLABORATOR'"
            ...
            <p class="text-gray-700 mb-4 text-center">
                Share your knowledge, inspire students worldwide and join our team of passionate educators.
                Help others discover new languages and cultures!
            </p>
            <router-link to="/coloaborators/join-master">
                <button
        ...
        <div v-if="userRole === 'BASIC'"
            class="flex-1 bg-white rounded-xl shadow-lg p-6 flex flex-col items-center justify-between transition-all">
            <h2 class="text-xl font-bold text-green-700 mb-2">Become a Globalang Collaborator</h2>
            <p class="text-gray-700 mb-4 text-center">
                Contribute casually, share phrases, regionalisms or cultural tips. Connect with a global community
                and help enrich our language resources!
            </p>
            <router-link to="/coloaborators/join-casual">
                <button
