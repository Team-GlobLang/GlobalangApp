...
import { getShortsFavorites } from "../Services/shortService";
...
const breadCumbs = [
  ...
  { label: "My Favorite Shorts", route: "/short/favorite-shorts" },
];
...
const {
  ...
  queryKey: computed(() => ["favorites-shorts", { country: country.value }]),
  queryFn: async ({ pageParam = 1 }) => {
    return await getShortsFavorites({
      page: pageParam,
      limit: 5,
